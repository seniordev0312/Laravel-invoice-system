          ...
          <div class="row row-30">
            ...
            <form id="buy_block" class="product-information" action="{{ sc_route('cart.add') }}" method="post">
              ...
              <div class="single-product">
                    ...
                    <span id="stock_status">
                        @if($product->stock <=0 && !sc_config('product_buy_out_of_stock'))
                            ...
                            <div class="product-stock">
                              In Stock Qty: <strong>{{ $product->stock }}</strong>
                            </div>
                            @endif 
                    </span> 
                </div>
                ...
                {{-- Size and Color info --}}
                <div>
                  {{ sc_language_render('product.size') }}: 
                  <span id="product-detail-size">{{ $product->getSize() }}</span>
                </div>
                <div>
                  {{ sc_language_render('product.color') }}: 
                  <span id="product-detail-color">{{ $product->getColor() }}</span>
                </div>
                {{--// Size and Color info --}}
