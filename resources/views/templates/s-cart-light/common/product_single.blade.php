<article class="product wow fadeInRight">
    <div class="product-body">
      ...
      <span class="product-title-custom">
        <span class="product-title-custom">
          <span class="product-title-custom">
            <a href="{{ $product->getUrl() }}" style="color: black">
                Size = <span style="color: red">{{ $product->getSize() }}</span> <br>
                Color = <span style="color: red">{{ $product->getColor() }}</span><br><br>
            </a>
        </span>
